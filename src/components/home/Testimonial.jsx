import { BookUp, BookUpIcon } from 'lucide-react'
  ...
  return (
   ...
   <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
     <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
           <BookUpIcon className='size-4.5 stroke-green-600' />
      ...
      <style>{`
        ...
        `}</style>
            ...
            <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none  from-white to-transparent"></div>
